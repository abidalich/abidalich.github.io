...
{
gdjs.copyArray(runtimeScene.getObjects("Score"), gdjs.Main_32MenuCode.GDScoreObjects1);
{for(var i = 0, len = gdjs.Main_32MenuCode.GDScoreObjects1.length ;i < len;++i) {
    gdjs.Main_32MenuCode.GDScoreObjects1[i].setString("Score: " + gdjs.evtTools.common.getVariableString(runtimeScene.getGame().getVariables().getFromIndex(1)));
}
}}
